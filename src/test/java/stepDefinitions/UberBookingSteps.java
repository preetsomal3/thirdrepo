...
public class UberBookingSteps {
	...
	public void user_select_car_and_pick_up_point_and_drop_point(String carType, String pickUpLocation, String dropLocation) {
	...
	public void user_pays_usd(Integer fare) {
		 System.out.println("Step 5: fare is "+fare);
	}
